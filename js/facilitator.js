  ...
  function renderRules() {
    ...
    var scenes = [
      ...
      },
      {
        ...
        min: minutesOf(/배분|정책/),
        name: "결정합니다",
        body: "주어진 투자예산금액을 투자합니다. 경영정책 " + polCount + "개 중 하나를 고릅니다. " +
    ...
    /* ★ 한 줄에 한 가지만. 설명을 붙이면 진행자가 읽다가 길을 잃습니다 —
         자세한 것은 그 장면이 올 때 그 화면에서 말합니다. */
    var nots = [
      "정답을 맞히는 게임이 아닙니다.",
      "다 잘할 수는 없습니다. 예산은 늘 모자랍니다.",
      "결과는 이 화면에서만 봅니다. 조 노트북에는 뜨지 않습니다.",
      "금액 단위가 시대마다 다릅니다. 1국면 한 칸 " + money(unit, firstScale) +
