/* ============================================================
   ...
   ◆ 배경음악은 두 곡뿐입니다. 시대나 국면이 아니라 '어디까지 왔는가' 로 갈립니다.
       평상시  표지부터 회고까지 — 6개 국면 전부 같은 곡
       엔딩곡  "우리는 이렇게 걸어왔습니다" ~ "그리고 2026년부터는"
     어느 화면에서 어느 곡을 트는지는 `data/config.js` 의 audio 에서 정합니다.
     두 곡 다 무한 반복입니다. 2분짜리라도 5분 국면 내내 끊기지 않습니다.
...
window.DRBAudio = (function () {
  ...
  /* ============================================================
     ...
     곡 이름(normal / finale)을 바로 줘도 됩니다.
     ============================================================ */
