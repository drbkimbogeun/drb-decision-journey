/* ============================================================
   ...
   ⚠⚠ 여기 있는 사건은 전부 '만들어낸 상황'입니다. DRB의 실제 기록이 아닙니다. ⚠⚠
     ...
     ★ 실제 연표와 헷갈릴 만한 사건에는 factNote 를 답니다.
       ...
       (예: 3국면의 단독 협력사 선정 — DRB에 그런 입찰이 있었던 적은 없습니다)
   ...
   ★★ 한 곳만 딸 수 있는 기회 (limited) ★★
     ...
     "한 회사만 계약한다" 는 기회가 있습니다 — 단독 협력사 선정 같은.
...
window.DRB_EVENTS = {
  ...
  e2_autoRequest: {
    id: "e2_autoRequest",
    title: "단독 협력사 선정 · 고객사 해외 이전",
    /* ★ 실제 회사도 연도도 연상시키지 않게 씁니다.
         바로 다음 화면(ACTUAL DRB)에 "1967. 2 현대자동차와 자동차용 고무부품
         공동개발" 이 나옵니다. 여기서 완성차 업체를 콕 집어 부르면, 참가자는
         방금 본 가정을 그 기록으로 기억합니다. 실제로 그렇게 읽혔습니다.

         '주요 고객사가 협력사를 한 곳만 고른다' 는 업계에 늘 있는 일이고,
         조들이 정면으로 부딪히게 하는 데는 그것으로 충분합니다.
         특정 업체·특정 계약을 가리키지 마세요. */
    factNote: "한 곳만 고르는 이 계약은 만들어낸 상황입니다. " +
              "1986년 DRB의 실제 기록은 기업부설연구소 설립입니다.",
    headline: "주요 고객사, 단독 협력사 선정 착수 — 생산기지 해외 이전도 가속",
    body: "주요 고객사 한 곳이 부품을 함께 개발할 협력사를 찾고 있습니다.\n" +
          "여러 곳과 나누지 않고 한 곳만 고른다고 합니다.\n\n" +
          "같은 시기, 고객들이 생산기지를 해외로 옮기며 현지 조달을 요구합니다.\n" +
    ...
    reactions: [
      {
        /* ★ 고객사는 협력사를 한 곳만 고릅니다.
             ...
             나머지는 개발비만 쓰고 물량을 못 받습니다 — 업계에 흔한 일입니다. */
        ...
        limited: {
          ...
          /* 돈만 많이 넣는다고 되지 않습니다. 만들 수 있는 회사인지, 믿을 만한
             회사인지, 사람이 있는지를 함께 봅니다. 고객사가 보는 것들입니다. */
          score: [
          ...
          lost: {
            text: "개발에 들어갔지만 협력사로 뽑히지 못했습니다 — 개발비는 이미 나갔습니다",
            mod: { delta: { cash: -8, fatigue: 4 }, mult: { demand: -0.03 } }
          }
        },
        text: "부품 개발에 들어가 있어 단독 협력사로 선정됐습니다",
