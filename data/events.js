/* ============================================================
   ...
   ⚠⚠ 여기 있는 사건은 전부 '만들어낸 상황'입니다. DRB의 실제 기록이 아닙니다. ⚠⚠
     ...
     ★ 실제 연표와 헷갈릴 만한 사건에는 factNote 를 답니다.
       ...
       (예: 3국면 자동차 공동개발 입찰 — 실제 DRB는 1967년 현대자동차와 했고,
             1986년에 남과 겨룬 입찰은 없었습니다)
...
window.DRB_EVENTS = {
  ...
  e2_autoRequest: {
    ...
    /* ★ 여기는 실제 DRB 연표와 헷갈리기 쉬운 자리입니다. 두 국면 뒤 ACTUAL DRB 에
         "1967. 2 현대자동차와 자동차용 고무부품 공동개발" 이 나오기 때문입니다.

         그래서 아래 factNote 가 빔에 같이 뜹니다. 상황은 상황대로 두고,
         무엇이 회사 기록인지는 그 자리에서 밝힙니다.

         ⚠ 완성차 업체를 실명으로 적지 마세요. 특정 회사와의 실제 계약을
           가리키는 순간, 없던 입찰이 회사 연표가 됩니다. */
